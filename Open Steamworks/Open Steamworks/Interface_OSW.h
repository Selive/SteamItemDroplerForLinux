...
#pragma once
	...
	static const char* k_cszSteam2LibraryName = "./Open Steamworks/Resources/Libs/libsteam.so";
	static const char* k_cszSteam3LibraryName = "./Open Steamworks/Resources/Libs/steamclient.so";
#else
